...
split queue        src/Viserio/Queue:git@github.com:n-viserio/queue.git            "master 0.10.0"
split routing      src/Viserio/Routing:git@github.com:n-viserio/routing.git        "master 0.10.0"
split security     src/Viserio/Security:git@github.com:n-viserio/security.git      "master 0.10.0"
