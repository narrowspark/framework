...
git subsplit publish --heads="master 0.10.0-dev" --no-tags src/Viserio/Link:git@github.com:viserio/link.git
...
git subsplit publish --heads="master 0.10.0-dev" --no-tags src/Viserio/Pipeline:git@github.com:viserio/parsers.git
git subsplit publish --heads="master 0.10.0-dev" --no-tags src/Viserio/Pipeline:git@github.com:viserio/pipeline.git
git subsplit publish --heads="master 0.10.0-dev" --no-tags src/Viserio/Queue:git@github.com:viserio/queue.git
