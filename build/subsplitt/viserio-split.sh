...
git subsplit publish --heads="master 0.10.0-dev" --no-tags src/Viserio/Cookie:git@github.com:viserio/cookie.git
git subsplit publish --heads="master 0.10.0-dev" --no-tags src/Viserio/Database:git@github.com:viserio/database.git
git subsplit publish --heads="master 0.10.0-dev" --no-tags src/Viserio/Encrypter:git@github.com:viserio/encrypter.git
git subsplit publish --heads="master 0.10.0-dev" --no-tags src/Viserio/Events:git@github.com:viserio/events.git
git subsplit publish --heads="master 0.10.0-dev" --no-tags src/Viserio/Exception:git@github.com:viserio/exception.git
...
git subsplit publish --heads="master 0.10.0-dev" --no-tags src/Viserio/Session:git@github.com:viserio/session.git
