...
class CompoundMatcherTest extends TestCase
{
    ...
    public function testGetHash()
    {
        ...
        self::assertSame('Viserio\Component\Routing\Matchers\CompoundMatcher:Viserio\Component\Routing\Matchers\StaticMatcher:test::Viserio\Component\Routing\Matchers\AnyMatcher:', $matcher->getHash());
    }
