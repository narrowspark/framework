...
class ValidatedComponentConfigurationFixture implements ProvidesDefaultOptionsContract, RequiresComponentConfigContract, RequiresMandatoryOptionsContract, RequiresValidatedConfigContract
{
    /**
     * {@inheritdoc}.
     */
