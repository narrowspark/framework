...
class ValidatedComponentConfigurationFixture implements ProvidesDefaultOptionContract, RequiresComponentConfigContract, RequiresMandatoryOptionContract, RequiresValidatedOptionContract
{
    /**
     * {@inheritdoc}.
     */
