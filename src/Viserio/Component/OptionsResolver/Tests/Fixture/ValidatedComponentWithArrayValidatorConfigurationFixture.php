...
class ValidatedComponentWithArrayValidatorConfigurationFixture implements ProvidesDefaultOptionsContract, RequiresComponentConfigContract, RequiresMandatoryOptionsContract, RequiresValidatedConfigContract
{
    /**
     * {@inheritdoc}.
     */
