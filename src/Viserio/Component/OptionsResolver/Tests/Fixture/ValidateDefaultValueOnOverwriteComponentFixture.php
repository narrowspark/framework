...
class ValidateDefaultValueOnOverwriteComponentFixture implements ProvidesDefaultOptionsContract, RequiresComponentConfigContract, RequiresMandatoryOptionsContract, RequiresValidatedConfigContract
{
    /**
     * {@inheritdoc}.
     */
