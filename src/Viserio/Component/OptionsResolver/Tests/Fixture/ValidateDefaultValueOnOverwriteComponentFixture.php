...
class ValidateDefaultValueOnOverwriteComponentFixture implements ProvidesDefaultOptionContract, RequiresComponentConfigContract, RequiresMandatoryOptionContract, RequiresValidatedOptionContract
{
    /**
     * {@inheritdoc}.
     */
