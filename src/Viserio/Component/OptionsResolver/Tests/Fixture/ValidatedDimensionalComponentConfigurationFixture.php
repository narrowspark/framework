...
class ValidatedDimensionalComponentConfigurationFixture implements ProvidesDefaultOptionsContract, RequiresComponentConfigContract, RequiresMandatoryOptionsContract, RequiresValidatedConfigContract
{
    /**
     * {@inheritdoc}.
     */
