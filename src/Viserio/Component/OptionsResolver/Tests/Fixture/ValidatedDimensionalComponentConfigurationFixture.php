...
class ValidatedDimensionalComponentConfigurationFixture implements ProvidesDefaultOptionContract, RequiresComponentConfigContract, RequiresMandatoryOptionContract, RequiresValidatedOptionContract
{
    /**
     * {@inheritdoc}.
     */
