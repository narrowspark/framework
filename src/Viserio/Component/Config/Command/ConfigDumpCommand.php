...
class ConfigDumpCommand extends AbstractCommand
{
     ...
     * {@inheritdoc}
     *
     * @throws \Viserio\Contract\Config\Exception\InvalidArgumentException if dir cant be created or is not writable
     */
    ...
    /**
     * Get a modified ConfigReader instance.
     *
     * @return \Viserio\Component\Config\Command\ConfigReader
     */
    private function getConfigReader(): ConfigReader
    {
        $command = $this;

        return new class($command) extends ConfigReader {
            /**
             * A ConfigDumpCommand instance.
             *
             * @var self
             */
            private $command;
             ...
             * @param self $command
             */
            public function __construct(ConfigDumpCommand $command)
            {
