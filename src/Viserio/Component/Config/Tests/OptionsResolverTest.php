...
use Viserio\Component\OptionsResolver\Tests\Fixture\ConnectionComponentDefaultConfigMandatoryContainedIdWithDeprecationKeyConfiguration;
...
use Viserio\Component\OptionsResolver\Tests\Fixture\ConnectionComponentDefaultConfigWithDeprecationKeyAndEmptyMessageConfiguration;
use Viserio\Component\OptionsResolver\Tests\Fixture\ConnectionComponentDefaultConfigWithDeprecationKeyAndInvalidMessageConfiguration;
use Viserio\Component\OptionsResolver\Tests\Fixture\ConnectionComponentDefaultConfigWithDeprecationKeyAndMessageConfiguration;
use Viserio\Component\OptionsResolver\Tests\Fixture\ConnectionComponentDefaultConfigWithDeprecationKeyConfiguration;
use Viserio\Component\OptionsResolver\Tests\Fixture\ConnectionComponentDefaultConfigWithMultiDimensionalDeprecationKeyConfiguration;
...
use Viserio\Component\OptionsResolver\Tests\Fixture\ConnectionDefaultConfigWithMandatoryConfiguration;
use Viserio\Component\OptionsResolver\Tests\Fixture\ConnectionDefaultConfigWithMoreThanOneMandatoryConfiguration;
...
use Viserio\Component\OptionsResolver\Tests\Fixture\PackageDefaultAndMandatoryConfigComponentConfiguration;
use Viserio\Component\OptionsResolver\Tests\Fixture\PackageDefaultConfigComponentConfiguration;
...
use Viserio\Contract\Config\Exception\MandatoryOptionNotFoundException;
use Viserio\Contract\Config\Exception\OptionNotFoundException;
...
final class OptionsResolverTest extends MockeryTestCase
{
    ...
    public function testOptionsThrowsInvalidArgumentExIfConfigIdIsProvidedButRequiresConfigIdIsNotImplemented(): void
    {
        ...
        $this->expectExceptionMessage('The factory [Viserio\\Component\\Config\\Tests\\Fixture\\ConnectionComponentConfiguration] does not support multiple instances.');
    ...
    {
        $this->expectException(OptionNotFoundException::class);
        $this->expectExceptionMessage('No options set for configuration [["doctrine" => ["connection"]]] in class [Viserio\\Component\\Config\\Tests\\Fixture\\ConnectionComponentConfiguration].');
    ...
    {
        $this->expectException(OptionNotFoundException::class);
        $this->expectExceptionMessage('No options set for configuration [["doctrine" => ["connection" => ["orm_default"]]]] in class [Viserio\\Component\\Config\\Tests\\Fixture\\ConnectionComponentContainerIdConfiguration].');
    ...
    {
        $this->expectException(OptionNotFoundException::class);
        $this->expectExceptionMessage('No options set for configuration [["one" => ["two" => ["three" => ["four"]]]]] in class [Viserio\\Component\\Config\\Tests\\Fixture\\FlexibleComponentConfiguration].');
    ...
    {
        $this->expectException(OptionNotFoundException::class);
        $this->expectExceptionMessage('No options set for configuration [["vendor"]] in class [Viserio\\Component\\Config\\Tests\\Fixture\\PackageDefaultAndMandatoryConfigComponentConfiguration].');

        $this->getOptionsResolver(
            new PackageDefaultAndMandatoryConfigComponentConfiguration(),
            []
        );
    }
    ...
    {
        $stub = new ConnectionComponentDefaultConfigMandatoryContainedIdConfiguration();
    ...
    public function testOptionsReturnsPackageDataWithDefaultOptionsIfNoConfigurationIsSet(): void
    {
        ...
        $options = $this->getOptionsResolver(
            new PackageDefaultConfigComponentConfiguration(),
            []
        );
    ...
    {
        $options = $this->getOptionsResolver(
            new ConnectionComponentDefaultConfigMandatoryContainedIdConfiguration(),
            $config,
            'orm_default'
        );
    ...
    {
        $options = $this->getOptionsResolver(
            new ConnectionComponentDefaultConfigConfiguration(),
            new ArrayIterator([])
        );
    ...
    {
        $options = $this->getOptionsResolver(
            new ConnectionDefaultConfigConfiguration(),
            []
        );
    ...
    public function testConnectionDefaultOptionsWithMandatoryConfiguration(): void
    {
        ...
        $this->getOptionsResolver(
            new ConnectionDefaultConfigWithMandatoryConfiguration(),
            []
        );
    }
    ...
    public function testConnectionDefaultOptionsWithMoreThanOneMandatoryConfiguration(): void
    {
        ...
        $this->getOptionsResolver(
            new ConnectionDefaultConfigWithMoreThanOneMandatoryConfiguration(),
            ['driverClass' => 'foo']
        );
    }
    ...
    public function testConnectionComponentDefaultOptionsWithDeprecationKeyConfiguration(): void
    {
        ...
        $this->getOptionsResolver(
            new ConnectionComponentDefaultConfigWithDeprecationKeyAndInvalidMessageConfiguration(),
            [
                'doctrine' => [
                    'connection' => [],
                ],
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('Deprecation message cant be empty, for option [params], in [' . ConnectionComponentDefaultConfigWithDeprecationKeyAndEmptyMessageConfiguration::class . '].');

        $this->getOptionsResolver(
            new ConnectionComponentDefaultConfigWithDeprecationKeyAndEmptyMessageConfiguration(),
            [
                'doctrine' => [
                    'connection' => [],
                ],
