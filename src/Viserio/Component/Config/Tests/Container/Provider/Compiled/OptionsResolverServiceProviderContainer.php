...
namespace Viserio\Component\Config\Tests\Provider\Compiled;
...
final class OptionsResolverServiceProviderContainer extends \Viserio\Component\Container\AbstractCompiledContainer
{
    ...
    public function __construct()
    {
        ...
        $this->methodMapping = [
            ...
            \Viserio\Component\Config\Command\OptionDumpCommand::class => 'get5a73c93dbe469f9f1fae0210ee64ef2ab32ed536467d0570a89353766859bb62',
            \Viserio\Component\Config\Command\OptionReaderCommand::class => 'get51bc2cdf2d87fcaa6a89ede54bc023ccfe784ddb4cc7a7e2be4ab3a7e9204471',
    ...
    protected function getce817e8bdc75399a693ba45b876c457a0f7fd422258f7d4eabc553987c2fbd31(): \Viserio\Component\Console\CommandLoader\IteratorCommandLoader
    {
        return $this->services[\Symfony\Component\Console\CommandLoader\CommandLoaderInterface::class] = new \Viserio\Component\Console\CommandLoader\IteratorCommandLoader(new \Viserio\Component\Container\RewindableGenerator(function () {
            yield 'option:dump' => ($this->services[\Viserio\Component\Config\Command\OptionDumpCommand::class] ?? $this->get5a73c93dbe469f9f1fae0210ee64ef2ab32ed536467d0570a89353766859bb62());

            yield 'option:read' => ($this->services[\Viserio\Component\Config\Command\OptionReaderCommand::class] ?? $this->get51bc2cdf2d87fcaa6a89ede54bc023ccfe784ddb4cc7a7e2be4ab3a7e9204471());
        }, 2));
    }
     ...
     */
    protected function get5a73c93dbe469f9f1fae0210ee64ef2ab32ed536467d0570a89353766859bb62(): \Viserio\Component\Config\Command\OptionDumpCommand
    {
        $this->services[\Viserio\Component\Config\Command\OptionDumpCommand::class] = $instance = new \Viserio\Component\Config\Command\OptionDumpCommand();
     ...
     */
    protected function get51bc2cdf2d87fcaa6a89ede54bc023ccfe784ddb4cc7a7e2be4ab3a7e9204471(): \Viserio\Component\Config\Command\OptionReaderCommand
    {
        $this->services[\Viserio\Component\Config\Command\OptionReaderCommand::class] = $instance = new \Viserio\Component\Config\Command\OptionReaderCommand();
