 ...
 * @internal
 *
 * @covers \Viserio\Component\Config\Command\ConfigDumpCommand
 *
 * @small
 */
final class ConfigDumpCommandTest extends CommandTestCase
{
    /** @var \org\bovigo\vfs\vfsStreamDirectory */
    private $root;

    /** @var \Viserio\Component\Config\Command\ConfigDumpCommand */
    private $command;
