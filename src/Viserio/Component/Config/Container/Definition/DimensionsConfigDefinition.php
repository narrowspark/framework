...
final class DimensionsConfigDefinition extends AbstractConfigDefinition implements RequiresComponentConfigContract
{
    use DimensionsTrait;
    ...
    /**
     * Create a new DimensionsConfigDefinition instance.
     *
