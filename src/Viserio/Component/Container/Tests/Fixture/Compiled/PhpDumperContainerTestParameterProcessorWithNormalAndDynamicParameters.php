 ...
 */
final class PhpDumperContainerTestParameterProcessorWithNormalAndDynamicParameters extends \Viserio\Component\Container\AbstractCompiledContainer
{
    /**
    ...
    *
    ...
    protected function doGetParameter(string $id)
    {
        switch ($id) {
            case 'viserio': $value = [
                'exception' => [
                    'debug' => $this->processParameter('{APP_DEBUG|env|bool}'),
                    'env' => $this->processParameter('{APP_ENV|env|string}'),
                ],
                'app' => [
                    'url' => $this->processParameter('{APP_URL|env|string}'),
                ],
                'logging' => [
                    'default' => $this->processParameter('{LOG_CHANNEL|env|string}'),
                    'env' => $this->processParameter('{APP_ENV|env|string}'),
                ],
                'view' => [
                    'paths' => [
                        0 => $this->processParameter('{resources|foo}/views'),
                    ],
                ],
            ]; break;
