...
final class CronTest extends MockeryTestCase
{
    ...
    public function testBasicCronCompilation(): void
    {
        ...
        static::assertEquals('* * * * *', $cron->getExpression());
        static::assertTrue($cron->isDue('test'));
        static::assertTrue($cron->skip(function () {
            return true;
        })->isDue('test'));
        static::assertFalse($cron->skip(function () {
            return true;
        })->filtersPass());
        ...
        static::assertEquals('* * * * *', $cron->getExpression());
        static::assertFalse($cron->setEnvironments('local')->isDue('test'));

        $cron = new Cron('php foo');

        static::assertEquals('* * * * *', $cron->getExpression());
        static::assertFalse($cron->when(function () {
            return false;
        })->filtersPass());
    }
    ...
    public function testGetExpression(): void
    {
        ...
        static::assertSame('* * * * *', $cron->getExpression());
    }
    ...
    public function testHourly(): void
    {
        ...
        static::assertSame('0 * * * *', $cron->hourly()->getExpression());
    }
    ...
    public function testDaily(): void
    {
        ...
        static::assertSame('0 0 * * *', $cron->daily()->getExpression());
    }
    ...
    public function testMonthly(): void
    {
        ...
        static::assertSame('0 0 1 * *', $cron->monthly()->getExpression());
    }
    ...
    public function testYearly(): void
    {
        ...
        static::assertSame('0 0 1 1 *', $cron->yearly()->getExpression());
    }
    ...
    public function testQuarterly(): void
    {
        ...
        static::assertSame('0 0 1 */3 *', $cron->quarterly()->getExpression());
    }
    ...
    public function testEveryMinute(): void
    {
        ...
        static::assertSame('* * * * *', $cron->everyMinute()->getExpression());
    }
    ...
    public function testEveryFiveMinutes(): void
    {
        ...
        static::assertSame('*/5 * * * *', $cron->everyFiveMinutes()->getExpression());
    }
    ...
    public function testEveryTenMinutes(): void
    {
        ...
        static::assertSame('*/10 * * * *', $cron->everyTenMinutes()->getExpression());
    }
    ...
    public function testEveryThirtyMinutes(): void
    {
        ...
        static::assertSame('0,30 * * * *', $cron->everyThirtyMinutes()->getExpression());
    }
    ...
    public function testDays(): void
    {
        ...
        static::assertSame('* * * * 1', $cron->days(1)->getExpression());
    }
    ...
    public function testMonthlyOn(): void
    {
        ...
        static::assertSame('0 15 4 * *', $cron->monthlyOn(4, '15:00')->getExpression());
    }
    ...
    public function testDailyAt(): void
    {
        ...
        static::assertSame('30 10 * * *', $cron->dailyAt('10:30')->getExpression());
    }
    ...
    public function testTwiceDaily(): void
    {
        ...
        static::assertSame('0 1,13 * * *', $cron->twiceDaily()->getExpression());
    }
    ...
    public function testTwiceMonthly(): void
    {
        ...
        static::assertEquals('0 0 1,16 * *', $cron->twiceMonthly(1, 16)->getExpression());
    }
    ...
    public function testWeekdays(): void
    {
        ...
        static::assertSame('* * * * 1-5', $cron->weekdays()->getExpression());
    }
    ...
    public function testMondays(): void
    {
        ...
        static::assertSame('* * * * 1', $cron->mondays()->getExpression());
    }
    ...
    public function testTuesdays(): void
    {
        ...
        static::assertSame('* * * * 2', $cron->tuesdays()->getExpression());
    }
    ...
    public function testWednesdays(): void
    {
        ...
        static::assertSame('* * * * 3', $cron->wednesdays()->getExpression());
    }
    ...
    public function testThursdays(): void
    {
        ...
        static::assertSame('* * * * 4', $cron->thursdays()->getExpression());
    }
    ...
    public function testFridays(): void
    {
        ...
        static::assertSame('* * * * 5', $cron->fridays()->getExpression());
    }
    ...
    public function testSaturdays(): void
    {
        ...
        static::assertSame('* * * * 6', $cron->saturdays()->getExpression());
    }
    ...
    public function testSundays(): void
    {
        ...
        static::assertSame('* * * * 0', $cron->sundays()->getExpression());
    }
    ...
    public function testWeekly(): void
    {
        ...
        static::assertSame('0 0 * * 0', $cron->weekly()->getExpression());
    }
    ...
    public function testWeeklyOn(): void
    {
        ...
        static::assertSame('0 0 * * 1', $cron->weeklyOn(1)->getExpression());
    }
    ...
    public function testBuildCommand(): void
    {
        ...
        static::assertSame("{$windows}php -i > {$quote}{$defaultOutput}{$quote} 2>&1{$background}", $cron->buildCommand());
    }
    ...
    public function testGetAndSetUser(): void
    {
        ...
        static::assertSame('root', $cron->setUser('root')->getUser());
    }
    ...
    public function testGetAndSetPath(): void
    {
        ...
        static::assertSame(__DIR__, $cron->setPath(__DIR__)->getPath());
    }
    ...
    public function testEnvironments(): void
    {
        ...
        static::assertTrue($cron->runsInEnvironment('dev'));
    }
    ...
    public function testBuildCommandSendOutputTo(): void
    {
        ...
        static::assertSame("{$windows}php -i > {$quote}/dev/null{$quote} 2>&1{$background}", $cron->buildCommand());

        $cron = new Cron('php -i');
        $cron->sendOutputTo('/my folder/foo.log');

        static::assertSame("{$windows}php -i > {$quote}/my folder/foo.log{$quote} 2>&1{$background}", $cron->buildCommand());
    }
    ...
    public function testGetSummaryForDisplay(): void
    {
        ...
        static::assertSame($cron->buildCommand(), $cron->getSummaryForDisplay());

        $cron->setDescription('test');

        static::assertSame('test', $cron->getSummaryForDisplay());
    }
    ...
    public function testTimeBetweenChecks(): void
    {
        ...
        static::assertTrue($cron->between('8:00', '10:00')->filtersPass());
        static::assertTrue($cron->between('9:00', '9:00')->filtersPass());
        static::assertFalse($cron->between('10:00', '11:00')->filtersPass());
        static::assertFalse($cron->unlessBetween('8:00', '10:00')->filtersPass());
        static::assertTrue($cron->unlessBetween('10:00', '11:00')->isDue('test'));
    }
    ...
    public function testCronJobIsDueCheck(): void
    {
        ...
        static::assertEquals('* * * * 4', $cron->thursdays()->getExpression());
        static::assertTrue($cron->isDue('test'));

        static::assertFalse($cron->isDue('test', true));

        $cron->evenInMaintenanceMode();

        static::assertTrue($cron->isDue('test', true));
    }
    ...
    public function testCronRun(): void
    {
        ...
        // OK
        static::assertSame(0, $cron->run());

        static::assertSame('before after', $_SERVER['test']);
    ...
    public function testFrequencyMacro(): void
    {
        ...
        static::assertEquals('*/6 * * * *', $cron->everyXMinutes(6)->getExpression());
    }
    ...
    public function testTimeBetweenBeforeAndAfterMidnight(): void
    {
        ...
        static::assertTrue($cron->between('21:00', '01:00')->filtersPass());
        static::assertFalse($cron->between('01:00', '21:00')->filtersPass());
        static::assertFalse($cron->between('23:00', '01:00')->filtersPass());

        static::assertFalse($cron->unlessBetween('21:00', '01:00')->filtersPass());
        static::assertTrue($cron->unlessBetween('23:00', '01:00')->isDue('prod'));
    }
}
