...
final class FilesystemTest extends TestCase
{
    ...
    public function testDeleteDirectory(): void
    {
        ...
        $this->assertDirectoryExists($dir->url());
        $this->assertFalse($this->files->deleteDirectory($file->url()));

        $this->files->deleteDirectory($dir->url());

        $this->assertDirectoryNotExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'temp'));
    ...
    public function testCleanDirectory(): void
    {
        ...
        $this->assertDirectoryExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tempdir'));
        $this->assertFileNotExists($file->url());
    }
    ...
    public function testMoveMovesFiles(): void
    {
        ...
        $this->assertFileNotExists($this->root->url() . \DIRECTORY_SEPARATOR . 'pop.txt');
    }
    ...
    public function testCreateDirectory(): void
    {
        ...
        $this->assertDirectoryExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'test'));
    ...
    public function testMoveDirectoryMovesEntireDirectory(): void
    {
        ...
        $this->assertDirectoryExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp2'));
        $this->assertFileExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp2') . \DIRECTORY_SEPARATOR . 'foo.txt');
        $this->assertFileExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp2') . \DIRECTORY_SEPARATOR . 'bar.txt');
        $this->assertDirectoryExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp2') . \DIRECTORY_SEPARATOR . 'nested');
        $this->assertFileExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp2') . \DIRECTORY_SEPARATOR . 'nested' . \DIRECTORY_SEPARATOR . 'baz.txt');
        $this->assertDirectoryNotExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp'));
    }
    ...
    public function testMoveDirectoryMovesEntireDirectoryAndOverwrites(): void
    {
        ...
        $this->assertDirectoryExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp2') . \DIRECTORY_SEPARATOR . 'nested');
        $this->assertFileExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp2') . \DIRECTORY_SEPARATOR . 'nested' . \DIRECTORY_SEPARATOR . 'baz.txt');
        $this->assertFileNotExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp2') . \DIRECTORY_SEPARATOR . 'foo2.txt');
        $this->assertFileNotExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp2') . \DIRECTORY_SEPARATOR . 'bar2.txt');
        $this->assertDirectoryNotExists(vfsStream::url('root' . \DIRECTORY_SEPARATOR . 'tmp'));
    }

    public function testCopyDirectoryReturnsFalseIfSourceIsntDirectory(): void
    {
        $this->assertFalse($this->files->copyDirectory(\DIRECTORY_SEPARATOR . 'foo' . \DIRECTORY_SEPARATOR . 'bar' . \DIRECTORY_SEPARATOR . 'baz' . \DIRECTORY_SEPARATOR . 'breeze' . \DIRECTORY_SEPARATOR . 'boom', 'foo'));
    }
    ...
    public function testFiles(): void
    {
        ...
        $this->assertContains('bar.txt', $this->files->files($dir->url()));
        $this->assertContains('foo.txt', $this->files->files($dir->url()));
        $this->assertNotContains('foo2.txt', $this->files->files($dir->url()));
    }
