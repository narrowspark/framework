<?php
namespace Brainwave\Console\Test\Command;
...
use Brainwave\Console\Command\ExpressionParser;
...
class ExpressionParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @test
     * @expectedException \Brainwave\Contracts\Console\Command\InvalidCommandExpression
