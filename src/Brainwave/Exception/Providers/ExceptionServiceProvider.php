<?php
namespace Brainwave\Exception\Providers;
...
use Brainwave\Exception\Adapter\ArrayDisplayer;
use Brainwave\Exception\Adapter\PlainDisplayer;
use Brainwave\Exception\Adapter\SymfonyDisplayer;
use Brainwave\Exception\Adapter\WhoopsDisplayer;
