...
use Brainwave\Container\Exception\CircularReferenceException;
use Brainwave\Container\Exception\UnresolvableDependencyException;
...
trait ContainerResolverTraits
{
     ...
     *
     * @throws \Brainwave\Container\Exception\UnresolvableDependencyException
     *
